...
namespace SweatyChair
{
	...
	public static class TutorialDebugger
	{
		...
		private static void ToggleAllTutorialsComplete(bool isCompleted)
		{
			...
			if (tmGO == null) {
				tmGO = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/SweatyChair/Essentials/Tutorials/TutorialManager.prefab");
				isInScene = false;
			}

			foreach (Tutorial t in TutorialSettings.current.tutorials)
